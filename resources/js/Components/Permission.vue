            ...
            <div class="overflow-x-auto">
              ...
              <tr>
                  ...
                  <tr>
                    ...
                    <td class='p-2 text-center'>
                      <Checkbox @click='markLine(range(349, 353), ORDEM)' v-model='lineChecked' class='ml-auto' :value='7' />
                    </td>
                    <td class='p-2 whitespace-nowrap text-center'>
                ...
                <td class='p-2 whitespace-nowrap'>
                  <div class='flex items-center'>
                  <div class='font-medium text-gray-800'>Funcionários</div>
                  </div>
                </td>
                <td class='p-2 text-center'>
                  <Checkbox @click='markLine(range(354, 358), ORDEM)' v-model='lineChecked' class='ml-auto' :value='8' />
                </td>
                <td class='p-2 whitespace-nowrap text-center'>
                ...
                <tr>
                  ...
                  <td class='p-2 text-center'>
                    <Checkbox @click='markLine(range(359, 363), ORDEM)' v-model='lineChecked' class='ml-auto' :value='9' />
                  </td>
                  <td class='p-2 whitespace-nowrap text-center'>
                  ...
                  <tr>
                    <td class='p-2 whitespace-nowrap'>
                      <div class='flex items-center'>
                      <div class='font-medium text-gray-800'>Aluguéis</div>
                      </div>
                    </td>
                    <td class='p-2 text-center'>
                      <Checkbox @click='markLine(range(364, 368), ORDEM)' v-model='lineChecked' class='ml-auto' :value='10' />
                    </td>
                    <td class='p-2 whitespace-nowrap text-center'>
